...
df = pd.read_csv(r'D:\university\DataMining\Ασκηση 1\movies_metadata.csv',low_memory=False)
...
df2 = pd.read_csv(r'D:\university\DataMining\Ασκηση 1\credits.csv',low_memory=False)
